...
2. Calls the [Hedera SDK Delete Allowance API](https://docs.hedera.com/hedera/sdks-and-apis/sdks/accounts-and-hbar/adjust-an-allowance) that allows a token owner to delete allowances. For NFTs, `deleteAllTokenNftAllowances` is called to delete the allowances for the given NFT ID. For hbar and fungible tokens, `approveTokenAllowance` is called with the amount of 0 to delete the allowances.
...
{% embed url="https://codepen.io/kpachhai/pen/mdoLyvo" %}
