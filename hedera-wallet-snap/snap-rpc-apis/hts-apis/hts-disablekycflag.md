...
3. Calls the [Hedera SDK Disable KYC Flag API](https://docs.hedera.com/hedera/sdks-and-apis/sdks/token-service/disable-kyc-account-flag) to revoke KYC from the Hedera accounts for the given Hedera token.
...
```json
{
    "currentAccount": {
        ...
        "balance": {
            "hbars": 96.20396081,
            "timestamp": "Thu, 25 Apr 2024 19:59:37 GMT",
            "tokens": {
                "0.0.4279119": {
                    "balance": 50,
                    "decimals": 1,
...
{% embed url="https://codepen.io/kpachhai/pen/JjVzKKM" %}
