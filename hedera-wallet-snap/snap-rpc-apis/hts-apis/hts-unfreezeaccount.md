...
const unfreezeAccountAPI = async () => {
...
3. Calls the [Hedera SDK Unfreeze Account API](https://docs.hedera.com/hedera/sdks-and-apis/sdks/token-service/unfreeze-an-account) to unfreeze an account. It unfreezes transfers of the specified token for the account.&#x20;
...
```json
{
    "currentAccount": {
        ...
        "balance": {
            "hbars": 96.49552529,
            "timestamp": "Thu, 25 Apr 2024 19:51:42 GMT",
            "tokens": {
                "0.0.4279119": {
                    "balance": 50,
                    "decimals": 1,
    ...
    "receipt": {
        ...
        "exchangeRate": {
            "hbars": 30000,
            "cents": 354162,
            "expirationTime": "Thu, 25 Apr 2024 21:00:00 GMT",
            "exchangeRateInCents": 11.8054
        },
...
{% embed url="https://codepen.io/kpachhai/pen/jORJrbE" %}
